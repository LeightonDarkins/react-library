...
import TopTextInput from "./TopTextInput.component";
...
describe("TopTextInput", () => {
  let container, getByLabelText, getByTestId, unmount;

  beforeEach(() => {
    let renderOutput = render(<TopTextInput id="test-id" label="a label" />);
  ...
  it("initially renders with no validation errors and no value", () => {
